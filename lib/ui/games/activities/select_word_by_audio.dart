          ...
          showDialog(
            ...
            builder: (BuildContext context) {
              return EndActivityPopup(
                  currentScreen: SelectWordAudio(subStoryId: widget.subStoryId, storyId: widget.storyId),
                      ...
                      Column(
                        ...
                        children: [
                          CustomButton(
                            ...
                            onPressed: () {
                              setState(() {
                                if (wordOne.toLowerCase().contains(letter.toLowerCase())) {
                                  answerFound = true;
                                }
                              });
                            },
                          ...
                          CustomButton(
                            ...
                            onPressed: () {
                              setState(() {
                                if (wordTwo.toLowerCase().contains(letter.toLowerCase())) {
                                  answerFound = true;
                                }
                              });
                            },
                      ...
                      Column(
                        ...
                        children: [
                          CustomButton(
                            ...
                            onPressed: () {
                              setState(() {
                                if (wordThree.toLowerCase().contains(letter.toLowerCase())) {
                                  answerFound = true;
                                }
                              });
                            },
                          ...
                          CustomButton(
                            ...
                            onPressed: () {
                              setState(() {
                                if (wordFour.toLowerCase().contains(letter.toLowerCase())) {
                                  answerFound = true;
                                }
                              });
                            },
