...
class _UpperLowerState extends State<UpperLower> {
  ...
  static const List<Color> majorSelectedColor = [
    Color(0xFFE1E6F1),
    Color(0xFFFB8231),
    Color(0xFFB87E67)
  ];
  ...
  bool checkAnswer() {
    ...
    print(("${minorSolved[minorSelected]} | ${majorSolved[majorSelected]} | ${majorSelected} | ${shuffledIndexes[majorSelected]}"));
                ...
                Row(
                  ...
                  children: [
                    ...
                    CustomButton(
                      ...
                      width: 250,
                      colorStart: const Color(0xFFFBB631),
                      colorEnd: Color(0xFFF7FB31),
                    ...
                    CustomButton(
                      ...
                      width: 250,
                      colorStart: const Color(0xFFFBB631),
                      colorEnd: const Color(0xFFF7FB31),
                      letterColor: Colors.black,
                    ),
                    const Spacer(
                      flex: 2,
